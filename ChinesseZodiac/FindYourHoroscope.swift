...
let oxText = "According to legend, if wasn’t for Ox’s innately kind, generous nature – and for Rat’s guile – Ox would be first in Sheng Xiao./nIn the famous race that determined this zodiac, Rat utilized not only Ox’s kindness, but also her capability. Knowing her strength and steadiness both on land and in water, Rat made a deal with Ox to ride across the water on her back, only to jump off near the finish line and win."
